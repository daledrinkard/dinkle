...
LCD_setting_table lcd_init_focuslcd[] =
{
 ...
 // {1,  {0x35},                               MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_0_PARAM, MIPI_DSI_CMD_FLAG_LOW_POWER},    //TE on
    {1,  {0x29},                               MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_0_PARAM, MIPI_DSI_CMD_FLAG_LOW_POWER},    // Display on
